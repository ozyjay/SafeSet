...
final class BackendBridge: @unchecked Sendable {
    ...
    func request(_ command: String, _ payload: [String: Any]) throws -> [String: Any] {
        ...
        case "source_text": message = "The original source contains unsupported spreadsheet text. Check that you selected the exact source used for protection."
        ...
        case "sheet_schema": message = "Selected worksheets do not have identical headings in the same order."
