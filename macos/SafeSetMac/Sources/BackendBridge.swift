...
final class BackendBridge: @unchecked Sendable {
    ...
    func request(_ command: String, _ payload: [String: Any]) throws -> [String: Any] {
        ...
        case "participant_configuration": message = "Choose an editable target sheet and a different reference-only sheet. Choose a source or Leave blank for every new participant field."
        ...
        case "participant_unique": message = "Each participant must occur once on the target sheet and once on the reference sheet for this comparison."
