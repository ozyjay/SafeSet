...
final class BackendBridge: @unchecked Sendable {
    ...
    func request(_ command: String, _ payload: [String: Any]) throws -> [String: Any] {
        ...
        case "participant_membership_permissions": message = "The membership sheet has editable fields in this private bundle. Choose a reference-only sheet or protect the workbook again with that sheet reference-only."
