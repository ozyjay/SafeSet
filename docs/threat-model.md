...
| Exact numeric disclosure | Version 2 requires bounds, precision and all-attribute group checks; genuine blank numeric cells remain blank and enter those checks | Exact values and missingness patterns remain visible and may be distinctive, even when category labels are coded |
