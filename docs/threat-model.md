...
| Hidden/unexpected columns | Explicit worksheet selection, exact selected-sheet and output schema, no passthrough | Incorrectly authored policy can still select inappropriate attributes or the wrong worksheet |
